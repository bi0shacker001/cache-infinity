...
class TLSAutomationService:
    ...
    def __init__(self, config_dir: Path, tls_settings: TLSSettings):
        ...
        Args:
            ...
            tls_settings: TLS settings from configuration
        """
    ...
    def ensure_certbot_installed(self) -> bool:
        ...
        Returns:
            True if certbot is available, False otherwise
        """
        try:
    ...
    def get_certificate(self) -> Optional[TLSCertificate]:
        ...
        Returns:
            TLSCertificate if available, None otherwise
        """
    ...
    def _get_http_certificate(self) -> Optional[TLSCertificate]:
        ...
        Returns:
            TLSCertificate if obtained successfully, None otherwise
        """
    ...
    def renew_certificate(self) -> bool:
        ...
        Returns:
            True if renewal succeeded or wasn't needed, False otherwise
        """
        if not self.ensure_certbot_installed():
            return False
    ...
    def _load_manual_certificate(self) -> TLSCertificate:
        ...
        Returns:
            TLSCertificate for manual configuration
        """
    ...
    def _get_existing_certificate(self, domains: list[str]) -> Optional[TLSCertificate]:
        ...
        Returns:
            TLSCertificate if found, None otherwise
        """
    ...
    def _parse_certificate_domains(self, cert_text: str) -> list[str]:
        ...
        Args:
            cert_text: Certificate text output from openssl
    ...
    def _parse_certificate_issuer(self, cert_text: str) -> Optional[str]:
        ...
        Returns:
            Issuer string if found, None otherwise
        """
    ...
    def cleanup_old_certificates(self, keep_days: int = 90) -> None:
        ...
        Args:
            keep_days: Number of days to keep certificates
        """
        try:
...
def create_tls_automation_service(config_dir: Path, tls_settings: TLSSettings) -> Optional[TLSAutomationService]:
    ...
    Returns:
        TLSAutomationService if TLS is enabled and configured, None otherwise
    """
