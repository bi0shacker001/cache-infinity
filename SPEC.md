...
### 6.3 SSH Host Keys (Durable, DB-backed)
...
### 9.2 Indexing at Scale and Metadata Performance (Normative)
...
#### 9.2.1 Browsable structure without full indexing
...
#### 9.2.2 On-demand indexing priority
...
#### 9.2.3 Per-domain rate limiting and backoff
...
#### 9.2.4 Target partitioning and giant-directory safety
...
#### 9.2.5 Metadata model requirements for fast WebDAV listings
...
#### 9.2.6 Streaming ingestion and bounded memory
...
#### 9.2.7 Short-lived listing cache
...
### 17.1 Two-Port Security Considerations
...
### 17.2 General Security Practices
